<?php
  ...
  if(isset($_POST['name']) && isset($_POST['email'])) {
    ...
    if($conn->setAttribute(PDO::ATTR_ERRMODE, PDO::ERRMODE_EXCEPTION)) {
      $voucherRequestQuery = "INSERT INTO `voucher_requests` SET `name`='$name', `email`='$email', `created_at`='$current_date'";
      if($conn->exec($voucherRequestQuery)){

        $mail = new PHPMailer;
        
        //From email address and name
        $mail->From = "robin-vo@web.de";
        $mail->FromName = "Packs Voucher Request";
        ...
        $mail->Subject = "Packs Voucher Request";
        $mail->Body = "Hello Packs Admin,<br><br>You have got a new voucher request from Packs contact form. Please have a look at the details:<br><br>Name: ".$name."<br>Email Address: ".$email."";
